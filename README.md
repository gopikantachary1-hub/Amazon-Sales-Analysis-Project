...
9. **Inventory Stock Alerts: Query products with stock levels below a certain threshold (e.g., less than 10 units). Include last restock date and warehouse information.**
```
SELECT
    i.inventory_id,
    p.product_name,
